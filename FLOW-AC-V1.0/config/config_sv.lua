...
ServerConfig.Debug = GetConvar("flowdebug", "false") == "true"

ServerConfig.BypassAcePerm = "flow.bypass"
...
ServerConfig.Modules = {
    ...
    Connect = {
        ...
        NoVPN = {
            enabled = true,
            rejectionMsg = "Conexion por vpn no habilitada por favor deje de usar el vpn para unirse a este servidor"
         },

        -- Filters non alphanumeric playernames.
        NameFilter = {
            enabled = true,
            rejectionMsg = "Su nombre contiene caracteres no alfanuméricos (a-Z, 0-9). Por favor, considere cambiar su nombre para poder conectarse."
         }
    },
